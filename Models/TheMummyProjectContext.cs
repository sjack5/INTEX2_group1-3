...
{
    public partial class TheMummyProjectContext : DbContext
    {
        public TheMummyProjectContext()
        {
        }

        public TheMummyProjectContext(DbContextOptions<TheMummyProjectContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Username=postgres;Password=POSTGRESpencer54321#;Database=TheMummyProject;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Bodyanalysischart>(entity =>
            {
                ...
                entity.Property(e => e.EstimateStature).HasMaxLength(500);

                entity.Property(e => e.Femur).HasMaxLength(50);

                entity.Property(e => e.FemurHeadDiameter).HasMaxLength(30);

                entity.Property(e => e.Gonion).HasMaxLength(50);

                entity.Property(e => e.Humerus).HasMaxLength(50);

                entity.Property(e => e.HumerusHeadDiameter).HasMaxLength(30);

                entity.Property(e => e.LamboidSuture).HasMaxLength(50);
                ...
                entity.Property(e => e.NuchalCrest).HasMaxLength(50);

                entity.Property(e => e.Observations).HasMaxLength(1000);

                entity.Property(e => e.OrbitEdge).HasMaxLength(50);

                entity.Property(e => e.Osteophytosis).HasMaxLength(500);

                entity.Property(e => e.ParietalBossing).HasMaxLength(50);
                ...
                entity.Property(e => e.PubicBone).HasMaxLength(50);

                entity.Property(e => e.Robust).HasMaxLength(500);

                entity.Property(e => e.SciaticNotch).HasMaxLength(50);

                entity.Property(e => e.SphenooccipitalSynchrondrosis).HasMaxLength(50);

                entity.Property(e => e.SquamosSuture).HasMaxLength(50);

                entity.Property(e => e.SubpubicAngle).HasMaxLength(50);

                entity.Property(e => e.SupraorbitalRidges).HasMaxLength(500);

                entity.Property(e => e.ToothAttrition).HasMaxLength(30);

                entity.Property(e => e.ToothEruption).HasMaxLength(500);

                entity.Property(e => e.ToothEruptionAgeEstimate).HasMaxLength(30);

                entity.Property(e => e.VentralArc).HasMaxLength(30);
